...
import { SidebarProps, NavigationItem } from '../../../types/design-system'
        ...
        switch (role) {
            ...
            default: // employee
                return [
                    ...
                    { icon: ClipboardList, label: 'My Tasks', path: '/tasks', section: 'Personal' },
                    { icon: Clock, label: 'Time Tracking', path: '/time-tracking', section: 'Personal' },
